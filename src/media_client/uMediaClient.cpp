...
uMediaClient::uMediaClient(bool rawEvents, UMSConnectorBusType bus)
...
bool uMediaClient::stateChange(UMSConnectorHandle* handle, UMSConnectorMessage* message, void* ctx)
{
	...
	if (name == "currentTime") {
		...
		long long currentTime = value.asNumber<int64_t>();
...
@page com_media_client uMediaClient
@{
@section com_media_client_setUri setUri

Required for 'channel change' in MVPD and one-shot URI for some other CPs.
...
*/
//->End of API documentation comment block
bool uMediaClient::setUri(string& uri, const string& option)
{
	pbnjson::JValue args = pbnjson::Object();
	args.put("mediaId",media_id);
	args.put("uri", marshallstring(uri));
...
@page com_media_client uMediaClient
@{
@section com_media_client_setSubtitleSource setSubtitleSource
...
Name | Required | Type | Description
-----|--------|------|----------
uri      | yes | String  | location of subtitle to be displayed.
...
*/
//->End of API documentation comment block
bool uMediaClient::setSubtitleSource(string& uri, std::string preferredEncodings)
{
	pbnjson::JValue args = pbnjson::Object();
	args.put("mediaId",media_id);
	args.put("uri", marshallstring(uri));
	...
	dispatchCall("/setSubtitleSource", args);
...
@page com_media_client uMediaClient
@{
@section com_media_client_setSubtitleEnable setSubtitleEnable
...
*/
//->End of API documentation comment block
bool uMediaClient::setSubtitleEnable(bool enable)
{
	pbnjson::JValue args = pbnjson::Object();
	args.put("mediaId",media_id);
	args.put("enable", marshallboolean(enable));

	dispatchCall("/setSubtitleEnable", args);
...
@page com_media_client uMediaClient
@{
@section com_media_client_setSubtitlePosition setSubtitlePosition
...
*/
//->End of API documentation comment block
bool uMediaClient::setSubtitlePosition(int32_t position)
{
	pbnjson::JValue args = pbnjson::Object();
	args.put("mediaId",media_id);
	args.put("position", marshalllong(position));

	dispatchCall("/setSubtitlePosition", args);
...
@page com_media_client uMediaClient
@{
@section com_media_client_setSubtitleSync setSubtitleSync
...
*/
//->End of API documentation comment block
bool uMediaClient::setSubtitleSync(int32_t sync)
{
	pbnjson::JValue args = pbnjson::Object();
	args.put("mediaId",media_id);
	args.put("sync", marshalllong(sync));

	dispatchCall("/setSubtitleSync", args);
...
@page com_media_client uMediaClient
@{
@section com_media_client_setSubtitleFontSize setSubtitleFontSize
...
*/
//->End of API documentation comment block
bool uMediaClient::setSubtitleFontSize(int32_t fontSize)
{
	pbnjson::JValue args = pbnjson::Object();
	args.put("mediaId",media_id);
	args.put("fontSize", marshalllong(fontSize));

	dispatchCall("/setSubtitleFontSize", args);
...
@page com_media_client uMediaClient
@{
@section com_media_client_setSubtitleColor setSubtitleColor
...
*/
//->End of API documentation comment block
bool uMediaClient::setSubtitleColor(int32_t color)
{
	pbnjson::JValue args = pbnjson::Object();
	args.put("mediaId",media_id);
	args.put("color", marshalllong(color));

	dispatchCall("/setSubtitleColor", args);
...
@page com_media_client uMediaClient
@{
@section com_media_client_setSubtitleEncoding setSubtitleEncoding
...
*/
//->End of API documentation comment block
bool uMediaClient::setSubtitleEncoding(std::string& encoding)
{
	pbnjson::JValue args = pbnjson::Object();
	args.put("mediaId",media_id);
	args.put("encoding", marshallstring(encoding));

	dispatchCall("/setSubtitleEncoding", args);
...
@page com_media_client uMediaClient
@{
@section com_media_client_setSubtitlePresentationMode setSubtitlePresentationMode
...
Name | Required | Type | Description
-----|--------|------|----------
presentationMode | yes | string | set subtitle PresentationMode
...
*/
//->End of API documentation comment block
bool uMediaClient::setSubtitlePresentationMode(std::string& presentationMode)
{
	pbnjson::JValue args = pbnjson::Object();
	args.put("mediaId",media_id);
	args.put("presentationMode", marshallstring(presentationMode));

	dispatchCall("/setSubtitlePresentationMode", args);
...
@page com_media_client uMediaClient
@{
@section com_media_client_setSubtitleCharacterColor setSubtitleCharacterColor
...
Name | Required | Type | Description
-----|--------|------|----------
charColor | yes | string | set subtitle Character Color
...
*/
//->End of API documentation comment block
bool uMediaClient::setSubtitleCharacterColor(std::string& charColor)
{
	pbnjson::JValue args = pbnjson::Object();
	args.put("mediaId",media_id);
	args.put("charColor", marshallstring(charColor));

	dispatchCall("/setSubtitleCharacterColor", args);
...
@page com_media_client uMediaClient
@{
@section com_media_client_setSubtitleCharacterOpacity setSubtitleCharacterOpacity
...
Name | Required | Type | Description
-----|--------|------|----------
charOpacity | yes | Integer | Set subtitle character opacity
...
*/
//->End of API documentation comment block
bool uMediaClient::setSubtitleCharacterOpacity(int32_t charOpacity)
{
	pbnjson::JValue args = pbnjson::Object();
	args.put("mediaId",media_id);
	args.put("charOpacity", marshalllong(charOpacity));

	dispatchCall("/setSubtitleCharacterOpacity", args);
...
@page com_media_client uMediaClient
@{
@section com_media_client_setSubtitleCharacterFontSize setSubtitleCharacterFontSize
...
Name | Required | Type | Description
-----|--------|------|----------
charFontSize | yes | string | Set subtitle Character font size
...
*/
//->End of API documentation comment block
bool uMediaClient::setSubtitleCharacterFontSize(std::string& charFontSize)
{
	pbnjson::JValue args = pbnjson::Object();
	args.put("mediaId",media_id);
	args.put("charFontSize", marshallstring(charFontSize));

	dispatchCall("/setSubtitleCharacterFontSize", args);
...
@page com_media_client uMediaClient
@{
@section com_media_client_setSubtitleCharacterFont setSubtitleCharacterFont
...
Name | Required | Type | Description
-----|--------|------|----------
charFont | yes | string | Set subtitle Character Font
...
*/
//->End of API documentation comment block
bool uMediaClient::setSubtitleCharacterFont(std::string& charFont)
{
	pbnjson::JValue args = pbnjson::Object();
	args.put("mediaId",media_id);
	args.put("charFont", marshallstring(charFont));

	dispatchCall("/setSubtitleCharacterFont", args);
...
@page com_media_client uMediaClient
@{
@section com_media_client_setSubtitleBackgroundColor setSubtitleBackgroundColor
...
Name | Required | Type | Description
-----|--------|------|----------
bgColor | yes | string | Set subtitle BackgroundColor
...
*/
//->End of API documentation comment block
bool uMediaClient::setSubtitleBackgroundColor(std::string& bgColor)
{
	pbnjson::JValue args = pbnjson::Object();
	args.put("mediaId",media_id);
	args.put("bgColor", marshallstring(bgColor));

	dispatchCall("/setSubtitleBackgroundColor", args);
...
@page com_media_client uMediaClient
@{
@section com_media_client_setSubtitleBackgroundOpacity setSubtitleBackgroundOpacity
...
Name | Required | Type | Description
-----|--------|------|----------
bgOpacity | yes | Integer | set subtitle Background Opacity
...
*/
//->End of API documentation comment block
bool uMediaClient::setSubtitleBackgroundOpacity(int32_t bgOpacity)
{
	pbnjson::JValue args = pbnjson::Object();
	args.put("mediaId",media_id);
	args.put("bgOpacity", marshalllong(bgOpacity));

	dispatchCall("/setSubtitleBackgroundOpacity", args);
...
@page com_media_client uMediaClient
@{
@section com_media_client_setSubtitleCharacterEdge setSubtitleCharacterEdge

set subtitle CharacterEdge

@par Parameters
Name | Required | Type | Description
-----|--------|------|----------
charEdgeType | yes | string | set subtitle CharacterEdge
...
*/
//->End of API documentation comment block
bool uMediaClient::setSubtitleCharacterEdge(std::string& charEdgeType)
{
	pbnjson::JValue args = pbnjson::Object();
	args.put("mediaId",media_id);
	args.put("charEdgeType", marshallstring(charEdgeType));

	dispatchCall("/setSubtitleCharacterEdge", args);
...
@page com_media_client uMediaClient
@{
@section com_media_client_setSubtitleWindowColor setSubtitleWindowColor
...
Name | Required | Type | Description
-----|--------|------|----------
windowColor | yes | string | set subtitle WindowColor
...
*/
//->End of API documentation comment block
bool uMediaClient::setSubtitleWindowColor(std::string& windowColor)
{
	pbnjson::JValue args = pbnjson::Object();
	args.put("mediaId",media_id);
	args.put("windowColor", marshallstring(windowColor));

	dispatchCall("/setSubtitleWindowColor", args);
...
@page com_media_client uMediaClient
@{
@section com_media_client_setSubtitleWindowOpacity setSubtitleWindowOpacity
...
Name | Required | Type | Description
-----|--------|------|----------
windowColor | yes | Integer | set subtitle WindowOpacity
...
*/
//->End of API documentation comment block
bool uMediaClient::setSubtitleWindowOpacity(int32_t windowOpacity)
{
	pbnjson::JValue args = pbnjson::Object();
	args.put("mediaId",media_id);
	args.put("windowOpacity", marshalllong(windowOpacity));

	dispatchCall("/setSubtitleWindowOpacity", args);
...
@page com_media_client uMediaClient
@{
@section com_media_client_setUpdateInterval setUpdateInterval
...
Name | Required | Type | Description
-----|--------|------|----------
key | yes | String | Parameter
value | yes | Integer | Interval
...
bool uMediaClient::setUpdateInterval(std::string &key, int32_t value)
{
	pbnjson::JValue args = pbnjson::Object();
	args.put("mediaId",media_id);
	...
	dispatchCall("/setUpdateIntervalKV", args);
...
bool uMediaClient::setUpdateInterval(int32_t currentTimeInterval, int32_t bufferRangeInterval)
{
	pbnjson::JValue args = pbnjson::Object();
	args.put("mediaId",media_id);
	args.put("currentTimeInterval", marshalllong(currentTimeInterval));
	args.put("bufferRangeInterval", marshalllong(bufferRangeInterval));

	dispatchCall("/setUpdateInterval", args);
...
@page com_media_client uMediaClient
@{
@section com_media_client_takeSnapshot takeSnapshot
...
*/
//->End of API documentation comment block
bool uMediaClient::takeSnapshot(std::string& location, std::string& format,	int32_t width, int32_t height, int32_t pictureQuality)
{
	pbnjson::JValue args = pbnjson::Object();
	args.put("mediaId",media_id);
	...
	dispatchCall("/takeSnapshot", args);
...
@page com_media_client uMediaClient
@{
@section com_media_client_startRecord startRecord
...
*/
//->End of API documentation comment block
bool uMediaClient::startRecord(std::string& location, std::string& format)
{
	pbnjson::JValue args = pbnjson::Object();
	args.put("mediaId",media_id);
	args.put("location", marshallstring(location));
...
@page com_media_client uMediaClient
@{
@section com_media_client_stopRecord stopRecord
...
*/
//->End of API documentation comment block
bool uMediaClient::stopRecord()
{
	pbnjson::JValue args = pbnjson::Object();
	args.put("mediaId",media_id);

	dispatchCall("/stopRecord", args);
...
@page com_media_client uMediaClient
@{
@section com_media_client_changeResolution changeResolution
...
*/
//->End of API documentation comment block
bool uMediaClient::changeResolution(int32_t width, int32_t height)
{
	pbnjson::JValue args = pbnjson::Object();
	args.put("mediaId",media_id);
	args.put("width", marshalllong(width));
	...
	dispatchCall("/changeResolution", args);
...
@page com_media_client uMediaClient
@{
@section com_media_client_setStreamQuality setStreamQuality
...
*/
//->End of API documentation comment block
bool uMediaClient::setStreamQuality(int32_t width, int32_t height, int32_t bitRate, bool init)
{
	pbnjson::JValue args = pbnjson::Object();
	args.put("mediaId",media_id);
	args.put("width", marshalllong(width));
	...
	dispatchCall("/setStreamQuality", args);
...
@page com_media_client uMediaClient
@{
@section com_media_client_setDescriptiveVideoService setDescriptiveVideoService

Determine whether DescriptiveVideoService is operating.
...
*/
//->End of API documentation comment block
bool uMediaClient::setDescriptiveVideoService(bool enable)
{
	pbnjson::JValue args = pbnjson::Object();
	args.put("mediaId",media_id);
	args.put("enable", marshallboolean(enable));

	dispatchCall("/setDescriptiveVideoService", args);
...
@page com_media_client uMediaClient
@{
@section com_media_client_setMasterClock setMasterClock
...
port | no  | integer | listening port. If this is 0, pipeline will allocate available port automatically and return
...
*/
//->End of API documentation comment block
bool uMediaClient::setMasterClock(const std::string& ip, int32_t port)
{
	/* TODO: Remove
	bool rv = waitEvent(&load_state, UMEDIA_CLIENT_MEDIAID_VALID,
						&mutex,	&load_state_cond, LOAD_TIMEOUT_SECONDS);
	if( rv == false ) {
		LOG_ERROR(_log, MSGERR_LOAD_TIMEOUT, "Load timeout.");
		return false;
	}
	*/
	...
	string cmd = m_umediaserver_connection_id + "/setMasterClock";
	connection->sendMessage(cmd, payload_serialized, commandResponseCallback, (void*)this);
...
@page com_media_client uMediaClient
@{
@section com_media_client_setSlaveClock
...
*/
//->End of API documentation comment block
bool uMediaClient::setSlaveClock(const std::string& ip, int32_t port, int64_t baseTime)
{
	/* TODO: Remove
	bool rv = waitEvent(&load_state, UMEDIA_CLIENT_MEDIAID_VALID,
						&mutex,	&load_state_cond, LOAD_TIMEOUT_SECONDS);
	...
	*/
	...
	string cmd = m_umediaserver_connection_id + "/setSlaveClock";
	connection->sendMessage(cmd, payload_serialized, commandResponseCallback, (void*)this);

	return true;
}

bool uMediaClient::setAudioDualMono(int audioMode)
{
	/* TODO: Delete
	bool rv = waitEvent(&load_state, UMEDIA_CLIENT_MEDIAID_VALID,
						&mutex,	&load_state_cond, LOAD_TIMEOUT_SECONDS);
	...
	*/
	...
	string cmd = m_umediaserver_connection_id + "/setAudioDualMono";
	connection->sendMessage(cmd, payload_serialized, commandResponseCallback, (void*)this);
...
// @brief set Property
//
bool uMediaClient::setProperty(string &payload)
{
	pbnjson::JValue args = pbnjson::Object();
	args.put("mediaId",media_id);
	args.put("payload", marshallstring(payload));

	dispatchCall("/setProperty", args);

	return true;
}

// @f logPipelineState
// @brief _log the tracked pipeline state
//
bool uMediaClient::logPipelineState()
{
	pbnjson::JValue args = pbnjson::Object();
	args.put("mediaId",media_id);

	dispatchCall("/logPipelineState", args);
...
// @brief send debug string to pipeline
//
bool uMediaClient::setPipelineDebugState(std::string& debug_state)
{
	pbnjson::JValue args = pbnjson::Object();
	args.put("mediaId", media_id);
	args.put("debugState", debug_state);

	dispatchCall("/setPipelineDebugState", args);
